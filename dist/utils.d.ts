...
declare function runGitMergeOnFolders(foldersPathWithGitConfig: Array<vscode.WorkspaceFolder>, branchOrigin?: string): Promise<void>;
declare function getSettingsByKey<T>(settingsExtensionKey: string, settingsKey: string): T;
